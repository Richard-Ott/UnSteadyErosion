...
switch scenario
    case 'step'
        ...
        testdata.e = [20,50,100,300,50,400,50,...    % old erosion rates of different catchments
                      1000,2000,5000,200,50,100,500];% new erosion rates of catchments
    ...
    case 'samebackground_step'
        ...
        testdata.chg = [10,20,50,100,2,60,30];       % change factor of erosion rate at time t
    ...
    case 'spike'
        ...
        testdata.loss =[50,20,1,  30, 10, 20, 40, ...
            10,20,30,40,50,60,70];       % soil loss in cm
    case 'samespike'
